    ...
    return (
        <section className="p-8 w-full">
            ...
            <div className="mt-6 space-y-4 p-4 rounded-lg mx-auto text-sm md:text-base">
                ...
                , a backend developer focused on building secure and efficient
                web services with{" "}
                <strong className="text-blue-600">Golang</strong>. I specialize
                in{" "}
                <strong className="text-blue-600">
                    PostgreSQL, caching (KeyDB, Redis), and server management
                </strong>
                ...
                <br/>
                <br/>
                I&apos;m a passionate Software Engineer with hands-on experience in building scalable              backend systems and full-stack applications. I specialize in Go, Node.js, and React with a strong foundation in data structures, algorithms, and system design. I&apos;ve developed and optimized microservices capable of handling high-traffic requests, implemented secure authentication systems (JWT, RBAC), andworked extensively with databases like PostgreSQL and MongoDB.
            </div>
        </section>
    );
};
