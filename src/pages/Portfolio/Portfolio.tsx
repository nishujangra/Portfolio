...
const Portfolio = () => {
    return (
        <div className="bg-foreground w-full h-full rounded-lg">
            ...
            <h2 className="text-3xl pl-10 font-extrabold">Portfolio</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-10">
                {projects.map((project, index) => (
                    <div
                        key={index}
                        className="bg-background rounded-lg p-5 shadow-lg hover:scale-105 transition-transform duration-300 flex flex-col gap-8"
                    >
                        <div>
                            <img
                                src={project.img}
