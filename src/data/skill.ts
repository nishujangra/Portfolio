...
const skill = [
    {
        ...
        description: 'JavaScript is a high-level, interpreted programming language that conforms to the ECMAScript specification. It is a core technology in web development.',
    },
    {
        name: 'TypeScript',
